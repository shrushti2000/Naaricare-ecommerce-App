...
const Categories = () => {
  ...
  return (
    ...
    {state.categories.map(item=>{
        return(
            <>
             <Link to="/productlistingpage" className='links' onClick={(e) => dispatch({ type: 'SET_CATEGORY', payload:item.categoryName })}>
          <div class="category">
            <img class="category-img img-responsive" src={item.img} alt="skincare-category-img" />
