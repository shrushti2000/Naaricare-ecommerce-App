    ...
    <>
      <div class="filter-sidebar flex-vt">
        <div class="filter-sidebar-items">
          ...
          <div class="filter-container">
            <label class="text-sm"> <input type="checkbox" name="category" checked={state.sortByFilters.sortByBrands.includes("Maybelline")} onChange={(e) => dispatch({ type: 'SET_BRAND', payload: "Maybelline" }, dispatch({ type: 'SET_SUB_CATEGORY', payload: null }))} />Maybelline</label>
            <label class="text-sm"> <input type="checkbox" name="category" checked={state.sortByFilters.sortByBrands.includes("L'Oreal")} onChange={(e) => dispatch({ type: 'SET_BRAND', payload: "L'Oreal" }, dispatch({ type: 'SET_SUB_CATEGORY', payload: null }))} />L'Oreal</label>
            <label class="text-sm"> <input type="checkbox" name="category" checked={state.sortByFilters.sortByBrands.includes("Lakme")} onChange={(e) => dispatch({ type: 'SET_BRAND', payload: "Lakme" }, dispatch({ type: 'SET_SUB_CATEGORY', payload: null }))} />Lakme</label>
            <label class="text-sm"> <input type="checkbox" name="category" checked={state.sortByFilters.sortByBrands.includes("Wow")} onChange={(e) => dispatch({ type: 'SET_BRAND', payload: "Wow" }, dispatch({ type: 'SET_SUB_CATEGORY', payload: null }))} />Wow</label>
            <label class="text-sm"> <input type="checkbox" name="category" checked={state.sortByFilters.sortByBrands.includes("Himalaya")} onChange={(e) => dispatch({ type: 'SET_BRAND', payload: "Himalaya" }, dispatch({ type: 'SET_SUB_CATEGORY', payload: null }))} />Himalaya</label>
            <label class="text-sm"> <input type="checkbox" name="category" checked={state.sortByFilters.sortByBrands.includes("Nivea")} onChange={(e) => dispatch({ type: 'SET_BRAND', payload: "Nivea" }, dispatch({ type: 'SET_SUB_CATEGORY', payload: null }))} />Nivea</label>
            <label class="text-sm"> <input type="checkbox" name="category" checked={state.sortByFilters.sortByBrands.includes("Sugar")} onChange={(e) => dispatch({ type: 'SET_BRAND', payload: "Sugar" }, dispatch({ type: 'SET_SUB_CATEGORY', payload: null }))} />Sugar</label>
            <label class="text-sm"> <input type="checkbox" name="category" checked={state.sortByFilters.sortByBrands.includes("POND'S")} onChange={(e) => dispatch({ type: 'SET_BRAND', payload: "POND'S" }, dispatch({ type: 'SET_SUB_CATEGORY', payload: null }))} />POND'S</label>
            <label class="text-sm"> <input type="checkbox" name="category" checked={state.sortByFilters.sortByBrands.includes("Mamaearth")} onChange={(e) => dispatch({ type: 'SET_BRAND', payload: "Mamaearth" }, dispatch({ type: 'SET_SUB_CATEGORY', payload: null }))} />Mamaearth</label>
            <label class="text-sm"> <input type="checkbox" name="category" checked={state.sortByFilters.sortByBrands.includes("Whisper")} onChange={(e) => dispatch({ type: 'SET_BRAND', payload: "Whisper" }, dispatch({ type: 'SET_SUB_CATEGORY', payload: null }))} />Whisper</label>
            <label class="text-sm"> <input type="checkbox" name="category" checked={state.sortByFilters.sortByBrands.includes("Stayfree")} onChange={(e) => dispatch({ type: 'SET_BRAND', payload: "Stayfree" }, dispatch({ type: 'SET_SUB_CATEGORY', payload: null }))} />Stayfree</label>
