            ...
            <div className='subheader-container'>
                <div className='subheader-section' onMouseLeave={(e) => showMakeupSubheaderDropdown(!makeupSubheaderDropdown)}>
                    ...
                    <div className='subheader-dropdown-makeup' style={{ display: `${makeupSubheaderDropdown ? 'flex' : 'none'}` }} >
                        <Link to="/productlistingpage"><p className='subheader-items' onClick={()=>dispatch({type:'SET_SUB_CATEGORY',payload:"Lipstick"})}>Lipstick</p></Link>
                        <Link to="/productlistingpage"><p className='subheader-items' onClick={()=>dispatch({type:'SET_SUB_CATEGORY',payload:"Foundation"})}>Foundation</p></Link>
                        <Link to="/productlistingpage"><p className='subheader-items' onClick={()=>dispatch({type:'SET_SUB_CATEGORY',payload:"Eyeshadow"})}>Eyeshadow</p></Link>
                        <Link to="/productlistingpage"><p className='subheader-items'  onClick={()=>dispatch({type:'SET_SUB_CATEGORY',payload:"Mascara"})}>Mascara</p></Link>
                    </div>
                </div>
                <div className='subheader-section' onMouseLeave={(e) => showBodyCareSubheaderDropdown(!bodyCareSubheaderDropdown)}>
                    ...
                    <div className='subheader-dropdown-skincare' style={{ display: `${bodyCareSubheaderDropdown ? 'flex' : 'none'}` }} >
                         <Link to="/productlistingpage"> <p className='subheader-items'  onClick={()=>dispatch({type:'SET_SUB_CATEGORY',payload:"BodyLotions"})}>Body Lotions</p></Link>
                         <Link to="/productlistingpage"> <p className='subheader-items'  onClick={()=>dispatch({type:'SET_SUB_CATEGORY',payload:"BodyWash"})}>Body wash</p></Link>
                    </div>
                </div>
                <div className='subheader-section' onMouseLeave={(e) => showHairCareSubheaderDropdown(!hairCareSubheaderDropdown)}>
                    ...
                    <div className='subheader-dropdown-haircare' style={{ display: `${hairCareSubheaderDropdown ? 'flex' : 'none'}` }} >
                         <Link to="/productlistingpage"> <p className='subheader-items'  onClick={()=>dispatch({type:'SET_SUB_CATEGORY',payload:"Shampoo"})}>Shampoos</p></Link>
                         <Link to="/productlistingpage"> <p className='subheader-items'  onClick={()=>dispatch({type:'SET_SUB_CATEGORY',payload:"HairOil"})}>Hair oils</p></Link>
                    </div>
                </div>
                <div className='subheader-section' onMouseLeave={(e) => showSkinCareSubheaderDropdown(!skinCareSubheaderDropdown)}>
                    ...
                    <div className='subheader-dropdown-skincare' style={{ display: `${skinCareSubheaderDropdown ? 'flex' : 'none'}` }} >
                         <Link to="/productlistingpage"> <p className='subheader-items' onClick={()=>dispatch({type:'SET_SUB_CATEGORY',payload:"FaceWash"})}>face Wash</p></Link>
                         <Link to="/productlistingpage"> <p className='subheader-items'  onClick={()=>dispatch({type:'SET_SUB_CATEGORY',payload:"Sunscreen"})}>Sun Screen</p></Link>
                         <Link to="/productlistingpage"> <p className='subheader-items'  onClick={()=>dispatch({type:'SET_SUB_CATEGORY',payload:"Moisturizer"})}>Moisturizers</p></Link>
                         <Link to="/productlistingpage"> <p className='subheader-items'  onClick={()=>dispatch({type:'SET_SUB_CATEGORY',payload:"FaceCream"})}>Day Creams</p></Link>
                    </div>
                </div>
                <div className='subheader-section' onMouseLeave={(e) => showMenstrualHygieneSubheaderDropdown(!menstrualHygieneSubheaderDropdown)}>
                    ...
                    <div className='subheader-dropdown-menstrual-hygiene' style={{ display: `${menstrualHygieneSubheaderDropdown ? 'flex' : 'none'}` }}  >
                         <Link to="/productlistingpage"> <p className='subheader-items'  onClick={()=>dispatch({type:'SET_SUB_CATEGORY',payload:"SanitaryPads"})}>Sanitary pads</p></Link>
                         <Link to="/productlistingpage"> <p className='subheader-items'  onClick={()=>dispatch({type:'SET_SUB_CATEGORY',payload:"Tampoons"})}>Tampoons</p></Link>
                    </div>
                </div>
